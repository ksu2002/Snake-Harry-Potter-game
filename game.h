...
int **create_game_field(int widht,
                        int height
                       );//создание игрового поля и заполнение 0 и 1
cell_snake *create_snake(int max_widht,
                         int max_height
                        );//создание змейки
void init_snake(int xhead, int yhead,
                cell_snake *snake,
                int **game_field
               );//инициализация змейки
void draw_game_field(int field_widht,
                     int field_height,
                     int **game_field
...
void draw_points(int points,
                 int windowheigth
                );// вывод текущего счёта на экран
void move_snake(int xhead, int yhead,
                cell_snake *snake,
                int snake_size,
                int **game_field
               );// расположение змеи
int change_direction(int *xhead,
                     int *yhead,
                     int *direction
                    );//смена направления движения змеи
void draw_snake_tail(int xxtemp, int xtemp,
                     int yytemp, int ytemp
                    );//отрисовка хвоста змеи
void draw_snake_head(int direction,
                     int xhead,
                     int yhead
                    );//отрисовка головы змеи
void draw_snake(cell_snake *snake,
                int direction
               );// отрисовка змеи
int create_food(
   int *food_x,
...
int  check_food_eaten(int **game_field,
                      int is_food_eaten,
                      int xhead,
                      int yhead,
                      int *snake_size,
